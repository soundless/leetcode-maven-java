 ...
 *
 * 
 * Implement a MyCalendar package algorithms.leetcode.median._729_my_calendar_i;

class to store your events. A new event can be added
 * if adding the event will not cause a double booking.
 * 
 * Your package algorithms.leetcode.median._729_my_calendar_i;
 ...
 * 
 */
package alg.median._729_my_calendar_i;
