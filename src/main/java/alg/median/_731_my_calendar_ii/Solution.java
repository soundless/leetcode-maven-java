 ...
 *
 * 
 * Implement a MyCalendarTwo package algorithms.leetcode.median._731_my_calendar_ii;

class to store your events. A new event can be
 * added if adding the event will not cause a triple booking.
 * 
 * Your package algorithms.leetcode.median._731_my_calendar_ii;
 ...
 * 
 */
package alg.median._731_my_calendar_ii;
