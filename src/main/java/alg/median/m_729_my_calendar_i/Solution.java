 ...
 *
 * 
 * Implement a MyCalendar package algorithms.leetcode.median.m_729_my_calendar_i;

class to store your events. A new event can be added
 * if adding the event will not cause a double booking.
 * 
 * Your package algorithms.leetcode.median.m_729_my_calendar_i;

class will have the method, book(int start, int end).  Formally, this
 ...
 * 
 */
package alg.median.m_729_my_calendar_i;
